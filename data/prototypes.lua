...
local make_new_medium_biters = function()
    local pt = table.deepcopy(data.raw["unit"]["medium-biter"])
    for i = 2, 5 do
        pt.name = "medium-biter-"..i
        pt.localised_name = {"", "Medium Biter Lvl ", i}
        pt.type = 'unit'
        pt = tint(pt, {r=1, g=(1-(i*0.2)), b=(1-(i*0.2))})
        pt = lvl_up(pt)
        pt = make_td_unit(pt)
...
local make_new_big_biters = function()
    local pt = table.deepcopy(data.raw["unit"]["big-biter"])
    for i = 2, 5 do
        pt.name = "big-biter-"..i
        pt.localised_name = {"", "Big Biter Lvl ", i}
        pt.type = 'unit'
        pt = tint(pt, {r=1, g=(1-(i*0.2)), b=(1-(i*0.2))})
        pt = lvl_up(pt)
        pt = make_td_unit(pt)
...
local make_new_behemoth_biters = function()
    local pt = table.deepcopy(data.raw["unit"]["behemoth-biter"])
    for i = 2, 5 do
        pt.name = "behemoth-biter-"..i
        pt.localised_name = {"", "Behemoth Biter Lvl ", i}
        pt.type = 'unit'
        pt = tint(pt, {r=1, g=(1-(i*0.2)), b=(1-(i*0.2))})
        pt = lvl_up(pt)
        pt = make_td_unit(pt)
...
make_new_medium_biters()
make_new_big_biters()
make_new_behemoth_biters()